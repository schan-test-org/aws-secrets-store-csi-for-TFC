...
variable "create_deploy_irsa" {
  description = "Create app-pod IRSA for service account"
  type        = bool
  default     = true
}
...
variable "namespace" {
  ...
  # type = map(object(
  # {
  #   namespace-default       = optional(string, "default")
  #   namespace-app-pod       = optional(string, "")
  # }
  # ))
...
variable "service_account_names" {
  description = "sa-apps for app-pods"
  # type = map(object(
  # {
  #   namespace-default       = optional(string, "default")
  #   namespace-app-pod       = optional(string, "")
...
# variable "service_account_name_deploy" {
#   description = "sa-apps for app-pods"
#   # default = {}
#   default     = "eks-deployment-sa"
...
variable "service_accounts" {
  ...
  type = list(object({
    ...
    # }))
    # external_secret = optional(object({
    #   is_need        = optional(bool, false)
    #   create         = optional(bool, false)
    #   object_name    = optional(string, "")
    #   object_type    = optional(string, "SSM")
    #   object_alias   = optional(string, "")
    #   object_version = optional(number, 1)
